...
My post-note on this journal is that the meat of the solution doesn't really start until the section titled [[*Figuring out where I'm stuck][Figuring out where I'm stuck]].
